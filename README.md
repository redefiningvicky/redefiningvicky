...
• <b>GIS & Remote Sensing:</b> ArcGIS (Online, Pro, StoryMaps & Dashboard), Google (Maps & Earth Engine), ENVI <p>
...
• Discover my current project [Humane Arc](https://www.humanearc.com/). <p>
